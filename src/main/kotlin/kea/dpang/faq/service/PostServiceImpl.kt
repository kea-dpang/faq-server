...
class PostServiceImpl(
    ...
    override fun createPost(userId: UUID, postCreateDto: PostCreateRequestDto): Post {
        ...
        val category = Category.entries.find { it.name == postCreateDto.categoryName.uppercase() }
            ?: throw CategoryNotFoundException(postCreateDto.categoryName)
    ...
    override fun updatePost(clientId: UUID, postId: Long, postUpdateDto: PostUpdateRequestDto): Post {
        ...
        val updatedCategory = Category.entries.find { it.name == postUpdateDto.categoryName.uppercase() }
            ?: throw CategoryNotFoundException(postUpdateDto.categoryName)
